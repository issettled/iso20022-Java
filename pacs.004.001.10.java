...
// Authorisation1Code 
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAttribute(required = true, name = "Authorisation1Code")
public class Authorisation1Code {
	protected String Authorisation1Code;
}
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAttribute(required = true, name = "ExternalReturnReason1Code")
public class ExternalReturnReason1Code {
	protected String ExternalReturnReason1Code;
}
...
public class GroupHeader90 {
	...
	@XmlElement(required = true, name = "GrpRtr")
	protected Boolean GrpRtr;
	@XmlElement(required = true, name = "TtlRtrdIntrBkSttlmAmt")
...
public class OriginalGroupHeader18 {
	...
	@XmlElement(required = true, name = "RtrRsnInf")
...
public class OriginalTransactionReference32 {
	...
	@XmlElement(required = true, name = "UndrlygCstmrCdtTrf")
...
public class PaymentTransaction118 {
	@XmlElement(required = true, name = "RtrId")
	...
	@XmlElement(required = true, name = "RtrdIntrBkSttlmAmt")
	...
	@XmlElement(required = true, name = "InstdAgt")
	protected BranchAndFinancialInstitutionIdentification6 InstdAgt;
	@XmlElement(required = true, name = "RtrChain")
