...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAttribute(required = true, name = "ExternalCancellationReason1Code")
public class ExternalCancellationReason1Code {
	protected String ExternalCancellationReason1Code;
}
...
public class FIToFIPaymentCancellationRequestV10 {
	...
	@XmlElement(required = true, name = "CtrlData")
...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAttribute(required = true, name = "GroupCancellationIndicator")
public class GroupCancellationIndicator {
	protected Boolean GroupCancellationIndicator;
}
...
public class OriginalGroupHeader15 {
	@XmlElement(required = true, name = "GrpCxlId")
	...
	@XmlElement(required = true, name = "CtrlSum")
	protected Float CtrlSum;
	@XmlElement(required = true, name = "GrpCxl")
	protected Boolean GrpCxl;
	@XmlElement(required = true, name = "CxlRsnInf")
...
public class PaymentTransaction137 {
	@XmlElement(required = true, name = "CxlId")
...
public class UnderlyingTransaction28 {
	@XmlElement(required = true, name = "OrgnlGrpInfAndCxl")
