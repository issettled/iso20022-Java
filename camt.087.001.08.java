...
@XmlAccessorType(XmlAccessType.FIELD)
@XmlAttribute(required = true, name = "ExternalAgentInstruction1Code")
public class ExternalAgentInstruction1Code {
	protected String ExternalAgentInstruction1Code;
}
...
public class RequestToModifyPaymentV08 {
	...
	@XmlElement(required = true, name = "Mod")
	protected RequestedModification10 Mod;
	@XmlElement(required = true, name = "InstrForAssgne")
...
public class RequestedModification10 {
	...
	@XmlElement(required = true, name = "Purp")
	protected Purpose2Choice Purp;
	@XmlElement(required = true, name = "InstrForDbtrAgt")
